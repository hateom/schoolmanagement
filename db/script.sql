...
FOREIGN KEY (SCH_TCH_ID) REFERENCES SM_TEACHER(TCH_ID) ON UPDATE CASCADE,
FOREIGN KEY (SCH_DAY_ID) REFERENCES SM_DAY(DAY_ID) ON UPDATE CASCADE,
FOREIGN KEY (SCH_RNG_ID) REFERENCES SM_RING(RNG_ID) ON UPDATE CASCADE,
FOREIGN KEY (SCH_CLS_ID) REFERENCES SM_CLASS(CLS_ID) ON UPDATE CASCADE,
FOREIGN KEY (SCH_CLR_ID) REFERENCES SM_CLASSROOM(CLR_ID) ON UPDATE CASCADE
)ENGINE = INNODB;