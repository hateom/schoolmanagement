...
public class MainJFrame extends javax.swing.JFrame implements Commander {
    ...
    private void initComponents() {
        ...
        jtbStudentsName = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        jbtnSNSearch = new javax.swing.JButton();
        ...
        jtbStudentsName.setText(resourceMap.getString("jtbStudentsName.text")); // NOI18N
        jtbStudentsName.setName("jtbStudentsName"); // NOI18N

        jLabel3.setText("Nazwisko: "); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N

        jbtnSNSearch.setText("Szukaj"); // NOI18N
        jbtnSNSearch.setName("jbtnSNSearch"); // NOI18N
        jbtnSNSearch.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnSNSearchActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtbStudentsName, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jbtnSNSearch)
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jbtnSNSearch)
                    .addComponent(jtbStudentsName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
...
private void jbtAddClassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAddClassActionPerformed
    // TODO add your handling code here:
    JNewClassDialog dlg = new JNewClassDialog(new Commander(){
            public void execute() {
                reloadClassData();
            }
        });
...
private void jbtAddRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAddRoomActionPerformed
    JNewClassroomDialog nc = new JNewClassroomDialog(new Commander(){
            public void execute() {
                reloadClassrooms();
            }
        });
...
String dateToTimeString( Date date )
{
    ...
    private javax.swing.JButton jbtnReload;
    private javax.swing.JButton jbtnSNSearch;
    ...
    private javax.swing.JTextField jtbStudentsName;
